...
Route::group(['middleware' => ['auth:sanctum']], function(){
    ...
    Route::get('admin/mascotas', [MascotaController::class, 'indexAdmin']);
        Route::get('admin/mascotas/por-usuario/{userId}', [CitaController::class, 'getMascotasByUser']); 
    ...
    Route::put('admin/citas/{id}', [CitaController::class, 'updateAdmin']);
    ...
    Route::get('/admin/citas/{id}', [CitaController::class, 'showAdmin']); 
});